...
export default function AssociationPage() {
    ...
    return (
        <main className="font-sans text-[#1F252D] bg-white">
            ...
            {/* HERO SECTION */}
            {/* ═══════════════════════════════════════════════════════════════════ */}
            <section className="relative bg-[#1F252D] text-white min-h-[600px] flex items-center overflow-hidden">
                {/* Background Image */}
                ...
                <div className="max-w-[1200px] mx-auto px-4 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center py-20 w-full">
                    {/* Text Content */}
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                        ...
                        <div className="lg:col-span-5 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4 h-full">
                            ...
                            <div className="bg-[#1F252D] p-6 flex flex-col items-center justify-center text-center text-white rounded-lg shadow-md h-full">
                                ...
                                <span className="text-xs uppercase font-medium">Des jeunes sans emploi stable</span>
                            </div>
                            {/* Stat 2 */}
                            <div className="bg-[#1F252D] p-6 flex flex-col items-center justify-center text-center text-white rounded-lg shadow-md h-full">
                                <div className="w-12 h-12 rounded-full bg-[#7A1C38] flex items-center justify-center mb-4">
                                ...
                                <span className="text-xs uppercase font-medium">École de cinéma à Djibouti</span>
                            </div>
                            {/* Stat 3 */}
                            <div className="bg-[#1F252D] p-6 flex flex-col items-center justify-center text-center text-white rounded-lg shadow-md h-full">
                                <div className="w-12 h-12 rounded-full bg-[#7A1C38] flex items-center justify-center mb-4">
                                ...
                                <span className="text-xs uppercase font-medium">N&apos;ont jamais touché une caméra pro</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="max-w-[1200px] mx-auto px-4">
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
                        ...
                        <div className="lg:w-1/2 w-full">
                            <h4 className="text-sm font-bold uppercase mb-6 text-center lg:text-left">Comment votre don agit</h4>
                            <div className="flex items-center justify-between text-center relative">
                                {/* Arrow Line background */}
                                <div className="absolute top-1/2 left-0 w-full h-0.5 bg-gray-200 -z-10 -translate-y-4"></div>
                                {/* Step 1 */}
                                <div className="flex flex-col items-center bg-white p-2 z-10">
                                    <div className="w-10 h-10 rounded-full bg-[#7A1C38] text-white flex items-center justify-center mb-2 text-xs">
                                    ...
                                    <span className="text-[10px] font-bold leading-tight">Votre<br />Don</span>
                                </div>
                                <svg className="w-3 h-3 text-[#D4AF37]" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd" /></svg>
                                {/* Step 2 */}
                                <div className="flex flex-col items-center bg-white p-2 z-10">
                                    <div className="w-10 h-10 rounded-full bg-[#7A1C38] text-white flex items-center justify-center mb-2 text-xs">
                                        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M2.166 4.999A11.954 11.954 0 0010 1.944 11.954 11.954 0 0017.834 5c.11.65.166 1.32.166 2.001 0 5.225-3.34 9.67-8 11.317C5.34 16.67 2 12.225 2 7c0-.682.057-1.35.166-2.001zm11.541 3.708a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" /></svg>
                                    </div>
                                    <span className="text-[10px] font-bold leading-tight">100%<br />Réinvesti</span>
                                </div>
                                <svg className="w-3 h-3 text-[#D4AF37]" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd" /></svg>
                                {/* Step 3 */}
                                <div className="flex flex-col items-center bg-white p-2 z-10">
                                    ...
                                    <span className="text-[10px] font-bold leading-tight">Formation</span>
                                </div>
                                <svg className="w-3 h-3 text-[#D4AF37]" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd" /></svg>
                                {/* Step 4 */}
                                <div className="flex flex-col items-center bg-white p-2 z-10">
                                    ...
                                    <span className="text-[10px] font-bold leading-tight">Equipement</span>
                                </div>
                                <svg className="w-3 h-3 text-[#D4AF37]" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd" /></svg>
                                {/* Step 5 */}
                                <div className="flex flex-col items-center bg-white p-2 z-10">
                                    ...
                                    <span className="text-[10px] font-bold leading-tight">Impact</span>
                                </div>
                                <svg className="w-3 h-3 text-[#D4AF37]" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd" /></svg>
                                {/* Result */}
                                <div className="flex flex-col items-center bg-white p-2 z-10">
                                    ...
                                    <span className="text-[8px] text-gray-500 max-w-[80px] mt-1">Des compétences garanties pour l&apos;avenir</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section id="axes" className="bg-[#F4F4F4] scroll-mt-24">
                ...
                <div className="max-w-[1200px] mx-auto px-4 py-12">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {/* Card 1 */}
                        <div className="relative h-64 group overflow-hidden rounded shadow-lg">
                            ...
                            <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center">
                                <h3 className="text-white text-2xl font-bold uppercase mb-4">Former</h3>
                                <Link href="/association/former" className="bg-[#D4AF37] text-white text-xs font-bold px-4 py-2 uppercase hover:bg-white hover:text-[#D4AF37] transition">En Savoir Plus</Link>
                            </div>
                        </div>
                        {/* Card 2 */}
                        <div className="relative h-64 group overflow-hidden rounded shadow-lg">
                            ...
                            <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center">
                                <h3 className="text-white text-2xl font-bold uppercase mb-4">Produire</h3>
                                <Link href="/association/produire" className="bg-[#D4AF37] text-white text-xs font-bold px-4 py-2 uppercase hover:bg-white hover:text-[#D4AF37] transition">En Savoir Plus</Link>
                            </div>
                        </div>
                        {/* Card 3 */}
                        <div className="relative h-64 group overflow-hidden rounded shadow-lg">
                            ...
                            <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center">
                                <h3 className="text-white text-2xl font-bold uppercase mb-4">Sensibiliser</h3>
                                <Link href="/association/sensibiliser" className="bg-[#D4AF37] text-white text-xs font-bold px-4 py-2 uppercase hover:bg-white hover:text-[#D4AF37] transition">En Savoir Plus</Link>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                            ...
                            <div className="flex flex-col group">
                                <div className="h-40 overflow-hidden rounded mb-4 shadow-md relative">
                                    <Image src="/cinema-nomade.png" alt="La Genèse" fill className="object-cover grayscale group-hover:scale-105 transition" />
                                </div>
                                <h4 className="text-sm font-bold uppercase text-[#1F252D]">La Genèse</h4>
                                <p className="text-xs text-gray-500 mb-1">27 oct - 2023</p>
                                <p className="text-xs text-gray-600 leading-snug">Jeunes formés du cinéma</p>
                            </div>
                            {/* Event 2 */}
                            <div className="flex flex-col group">
                                <div className="h-40 overflow-hidden rounded mb-4 shadow-md relative">
                                    <Image src="/equipe-formation.jpg" alt="Premières Formations" fill className="object-cover grayscale group-hover:scale-105 transition" />
                                </div>
                                <h4 className="text-sm font-bold uppercase text-[#1F252D]">Premières Formations</h4>
                                <p className="text-xs text-gray-500 mb-1">25 fév - 2023</p>
                                <p className="text-xs text-gray-600 leading-snug">Jeunes formés</p>
                            </div>
                            {/* Event 3 */}
                            <div className="flex flex-col group">
                                <div className="h-40 overflow-hidden rounded mb-4 shadow-md relative">
                                    <Image src="/festivaldecinemacom.jpg" alt="Le Premier Festival" fill className="object-cover grayscale group-hover:scale-105 transition" />
                                </div>
                                <h4 className="text-sm font-bold uppercase text-[#1F252D]">Le Premier Festival</h4>
                                <p className="text-xs text-gray-500 mb-1">27 jan - 2023</p>
                                <p className="text-xs text-gray-600 leading-snug">Premier Festival</p>
                            </div>
                            {/* Event 4 */}
                            <div className="flex flex-col group">
                                <div className="h-40 overflow-hidden rounded mb-4 shadow-md relative">
                                    <Image src="/formationgroupecom.jpg" alt="L'Expansion" fill className="object-cover grayscale group-hover:scale-105 transition" />
                                </div>
                                <h4 className="text-sm font-bold uppercase text-[#1F252D]">L&apos;Expansion</h4>
                                <p className="text-xs text-gray-500 mb-1">29 Jan - 2030</p>
                                <p className="text-xs text-gray-600 leading-snug">Centres formés</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <div className="w-full bg-gray-200 h-2 rounded-full overflow-hidden">
                                    <div className="bg-[#7A1C38] h-full" style={{ width: '1.5%' }}></div>
                                </div>
                            </div>
                            {/* Item 2 */}
                            <div>
                                ...
                                <div className="w-full bg-gray-200 h-2 rounded-full overflow-hidden">
                                    <div className="bg-[#7A1C38] h-full" style={{ width: '1%' }}></div>
                                </div>
                            </div>
                            {/* Item 3 */}
                            <div>
                                ...
                                <div className="w-full bg-gray-200 h-2 rounded-full overflow-hidden">
                                    <div className="bg-[#7A1C38] h-full" style={{ width: '0.5%' }}></div>
                                </div>
                            </div>
                            {/* Item 4 */}
                            <div>
            ...
            <section id="partenaires" className="bg-white py-10 border-t border-gray-200 scroll-mt-24">
                <div className="max-w-[1200px] mx-auto px-4">
                    ...
                    <div className="flex flex-wrap justify-between items-center gap-8 opacity-70 grayscale hover:grayscale-0 transition duration-300">
                        {PARTNERS.map((partner, index) => (
                            <div key={index} className="relative h-24 w-40 flex items-center justify-center">
                                <Image
                                    src={partner.src}
                                    alt={partner.alt}
                                    fill
