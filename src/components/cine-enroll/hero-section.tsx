...
export default function HeroSection({ onScrollToForm }: HeroSectionProps) {
  return (
    <section className="relative h-screen w-full flex flex-col justify-center">
      ...
      {/* Main Content */}
      <div className="relative z-10 container mx-auto px-4 text-white max-w-4xl flex-grow flex flex-col justify-center">
        <div className="flex flex-col items-start space-y-4 md:space-y-6">
          <div className="bg-yellow-400 text-black text-xs font-bold uppercase tracking-wider px-3 py-1 rounded-sm shadow-[0_0_15px_rgba(250,204,21,0.4)]">
            Masterclass
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-lg">5.0 (Djibouti)</span>
          </div>
