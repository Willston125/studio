  ...
  return (
    <html lang="fr" className="dark">
      <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Montserrat:ital,wght@0,400;0,700;1,400&family=Playfair+Display:wght@700&family=Garamond:wght@400&display=swap" rel="stylesheet" />
      </head>
